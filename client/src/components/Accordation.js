    ...
    const accords = [
        {
            ...
            summary: " Companies which would like to recruit freshers visit the institutes, conduct the process of recruitment and recruit the students when they are in final year of bsc. It will be a day-long process."
        },
        {
            id: 2,
        ...
        },
        {
            ...
            summary: ` Various companies have different eligibility criteria. However, there are companies which do not have any eligibility criteria. All the students studying in the final year will become eligible in that case. Some of the eligibility criteria to participate in the campus placements are given below:
                            ...
                            <ul>
                                ...
                                <li>bsc aggregate marks – 60%</li>
                                <li>Can/cannot have live KTs</li>
                                <li>Can/cannot have Dead KTs</li>
                                <li>Can/cannot have Gap during bsc/Gap during education</li>
                            </ul>
...
<BR />
Questions will be asked on the basics of bsc subjects studied.
<BR />
